	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  <li class=""><a  href='<c:url value='/trang-chu'/>'>Home	</a></li>
...
-->
	...
	<table class="table table-bordered table-condensed">
              ...
              <tbody>
              	...
              	<c:forEach items="${Cart}" var="item">
						<tr>
                  <td><img width="100"  src="${ item.value.product.image }"   alt=""></td>
                  <td>${ item.value.product.description }</td>
                  <td> - </td>
                  <td><span class="shopBtn"><span class="icon-ok"></span></span> </td>
                  <td>${ item.value.product.price }</td>
                  <td>
				  <input type="number" min="0" max="12" class="span1" style="max-width:34px" placeholder="1" size="16" type="text">
				  <div class="input-append">
					<button class="btn btn-mini" type="button">-
					</button><button class="btn btn-mini" type="button">+
					</button><button class="btn btn-mini btn-danger" type="button">
					<a href='<c:url value='/cart/DeleteCart/${item.key}'/>'  class="icon-remove"></a></button>
				</div>
				  </td>
                ...
                <tr>
                  ...
                  <td> ${ TotalQuantyCart }</td>
                </tr>
				 <tr>
                  <td colspan="6" class="alignR">Total Price Cart:	</td>
                  <td class="label label-primary">${TotalPriceCart }</td>
                </tr>
				</tbody>
            </table><br/>
	...
	<a href='<c:url value='/cart/Order'/>' class="shopBtn btn-large pull-right">Next <span class="icon-arrow-right"></span></a>
...
<!-- <section class="our_client">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt="" src="<c:url value="template/web/img/1.png"/>" ></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="<c:url value="template/web/img/2.png"/>" ></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="<c:url value="template/web/img/3.png"/>" ></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="<c:url value="template/web/img/4.png"/>" ></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="<c:url value="template/web/img/5.png"/>" ></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="<c:url value="template/web/img/6.png"/>" ></a>
		</div>
	</div>
</section> -->
